...
from .views import StocksView, PortfolioView, CompanyArticleViewList, CompanyReportViewList, StockPricesDataView, StocksRandomViewList, StocksMoversView
...
urlpatterns = [
  ...
  path("reports/<int:company_id>", CompanyReportViewList.as_view(), name="company-reports"), 
]
